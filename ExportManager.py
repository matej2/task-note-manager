...
class ExportManager:
    ...
    def export_data(self) -> None:
        ...
        self.add_sheet_row(sheet_content, self.config_manager.export_file_tab_name_default)
    ...
    def export_task_names(self) -> None:
        for i in range(0, 7):
            ...
            if len(note_list) > 0:
                ...
                self.add_sheet_row([result], self.config_manager.export_file_tab_name_task_names)
